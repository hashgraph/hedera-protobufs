...
| state_proof | [BlockProof](#com-hedera-hapi-block-stream-BlockProof) |  | A block state proof.<br/> The state proof for the BlockInfo node in the network state at the end of this block.<br/> This item is not part of the block stream hash chain/tree, and marks the end of a block. |
