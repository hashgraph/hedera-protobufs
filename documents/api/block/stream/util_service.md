...
- [stream/util_service.proto](#stream_util_service-proto)
    - [UtilPrngOutput](#proto-UtilPrngOutput)
...
| prng_number | [int32](#int32) |  | A deterministic pseudo-random number generated within a specified range.<br/> This value SHALL be the result of a corresponding `UtilService` `prng` transaction. |
