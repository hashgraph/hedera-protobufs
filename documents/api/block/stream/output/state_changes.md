...
| tss_encryption_key_value | [com.hedera.hapi.services.auxiliary.tss.TssEncryptionKeyTransactionBody](#com-hedera-hapi-services-auxiliary-tss-TssEncryptionKeyTransactionBody) | The value of a map that stores tss encryption keys for each node. |
...
| tss_status_state_value | [com.hedera.hapi.node.state.tss.TssStatus](#com-hedera-hapi-node-state-tss-TssStatus) | A change to the tss status state singleton. |
