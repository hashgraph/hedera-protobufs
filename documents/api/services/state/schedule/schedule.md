...
| Field | Type | Description |
| ----- | ---- | ----------- |
| schedule_ids | [ScheduleID](#proto-ScheduleID) | A list of schedules, in encounter order. |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| schedules | [Schedule](#proto-Schedule) | A list of schedules, in encounter order. |
