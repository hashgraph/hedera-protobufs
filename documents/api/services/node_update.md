...
Upon successful completion the `node_id` for the updated entry SHALL be
repeated in the transaction receipt.<br/>
The `node_id` in the transaction receipt SHALL match the `node_id`
...
| description | [google.protobuf.StringValue](#google-protobuf-StringValue) |  | A short description of the node. <p> This value, if set, MUST NOT exceed 100 bytes when encoded as UTF-8.<br/> If set, this value SHALL replace the previous value. |
