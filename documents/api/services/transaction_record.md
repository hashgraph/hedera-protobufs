...
| tokenTransferLists | [TokenTransferList](#proto-TokenTransferList) | A token transfer list for this transaction.<br/> This is a list of all non-HBAR token transfers completed for this transaction.<br/> |
...
| assessed_custom_fees | [AssessedCustomFee](#proto-AssessedCustomFee) | A list of all custom fees that were assessed during a CryptoTransfer. <p> These SHALL be paid if the transaction status resolved to SUCCESS. |
| automatic_token_associations | [TokenAssociation](#proto-TokenAssociation) | A list of all token associations implicitly or automatically created while handling this transaction. |
...
| paid_staking_rewards | [AccountAmount](#proto-AccountAmount) | A list of staking rewards paid. <p> This SHALL be a list accounts with the corresponding staking rewards paid as a result of this transaction. |
