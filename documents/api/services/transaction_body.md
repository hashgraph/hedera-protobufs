...
| memo | [string](#string) |  | A short description for this transaction. <p> This value, if set, MUST NOT exceed 100 bytes when encoded as UTF-8. |
...
| cryptoAddLiveHash | [CryptoAddLiveHashTransactionBody](#proto-CryptoAddLiveHashTransactionBody) |  | An obsolete, and unsupported, operation to add a "live hash" to an account. |
...
| cryptoDeleteLiveHash | [CryptoDeleteLiveHashTransactionBody](#proto-CryptoDeleteLiveHashTransactionBody) |  | An obsolete, and unsupported, operation to remove a "live hash" from an account. |
